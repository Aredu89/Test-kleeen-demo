...
/**
 * Add
 * @desc Redux-Observable Epic which allows to add an entity in "bookStoreMain" workflow.
 */
...
/**
 * Bulk Add
 * @desc Redux-Observable Epic which allows to add entities in bulk in "bookStoreMain" workflow.
 */
...
/**
 * Delete
 * @desc Redux-Observable Epic which allows to delete an entity in "bookStoreMain" workflow.
 */
...
/**
 * Bulk Delete
 * @desc Redux-Observable Epic which allows to delete entities in bulk in "bookStoreMain" workflow.
 */
...
/**
 * Safe Delete
 * @desc Redux-Observable Epic which allows to safely delete entities in "bookStoreMain" workflow.
 */
export function safeDelete(action$) {
  return action$.pipe(
    ofType(actions.safeDeleteRequest.type),
    mergeMap((action) =>
      BaseApiService.graphqlEntityCRUD('bookStoreMain')
        .delete({
          id: action.payload && action.payload.id,
        })
        .pipe(
 ...
 * @desc Redux-Observable Epic which allows to dispatch a custom action in "bookStoreMain" workflow.
 */
...
/**
 * Get
 * @desc Redux-Observable Epic which allows to get an entity in "bookStoreMain" workflow.
 */
...
/**
 * Auto Complete
 * @desc Redux-Observable Epic which allows to auto-complete values in "bookStoreMain" workflow.
 */
...
/**
 * Get Widget Data
 * @desc Redux-Observable Epic which allows to get the data for a widget in "bookStoreMain" workflow.
 */
...
/**
 * Update
 * @desc Redux-Observable Epic which allows to update an entity in "bookStoreMain" workflow.
 */
...
/**
 * Bulk Update
 * @desc Redux-Observable Epic which allows to update entities in bulk in "bookStoreMain" workflow.
 */
