...
/**
 * Add
 * @desc Redux-Observable Epic which allows to add an entity in "sectionDetails" workflow.
 */
...
/**
 * Bulk Add
 * @desc Redux-Observable Epic which allows to add entities in bulk in "sectionDetails" workflow.
 */
...
/**
 * Delete
 * @desc Redux-Observable Epic which allows to delete an entity in "sectionDetails" workflow.
 */
...
/**
 * Bulk Delete
 * @desc Redux-Observable Epic which allows to delete entities in bulk in "sectionDetails" workflow.
 */
...
/**
 * Safe Delete
 * @desc Redux-Observable Epic which allows to safely delete entities in "sectionDetails" workflow.
 */
 ...
 * @desc Redux-Observable Epic which allows to dispatch a custom action in "sectionDetails" workflow.
 */
...
/**
 * Get
 * @desc Redux-Observable Epic which allows to get an entity in "sectionDetails" workflow.
 */
...
/**
 * Auto Complete
 * @desc Redux-Observable Epic which allows to auto-complete values in "sectionDetails" workflow.
 */
...
/**
 * Get Widget Data
 * @desc Redux-Observable Epic which allows to get the data for a widget in "sectionDetails" workflow.
 */
...
/**
 * Update
 * @desc Redux-Observable Epic which allows to update an entity in "sectionDetails" workflow.
 */
...
/**
 * Bulk Update
 * @desc Redux-Observable Epic which allows to update entities in bulk in "sectionDetails" workflow.
 */
