...
/**
 * Add
 * @desc Redux-Observable Epic which allows to add an entity in "publisherDetails" workflow.
 */
...
/**
 * Bulk Add
 * @desc Redux-Observable Epic which allows to add entities in bulk in "publisherDetails" workflow.
 */
...
/**
 * Delete
 * @desc Redux-Observable Epic which allows to delete an entity in "publisherDetails" workflow.
 */
...
/**
 * Bulk Delete
 * @desc Redux-Observable Epic which allows to delete entities in bulk in "publisherDetails" workflow.
 */
...
/**
 * Safe Delete
 * @desc Redux-Observable Epic which allows to safely delete entities in "publisherDetails" workflow.
 */
export function safeDelete(action$) {
  return action$.pipe(
    ofType(actions.safeDeleteRequest.type),
    mergeMap((action) =>
      BaseApiService.graphqlEntityCRUD('Publisher')
        .delete({
          id: action.payload && action.payload.id,
        })
        .pipe(
 ...
 * @desc Redux-Observable Epic which allows to dispatch a custom action in "publisherDetails" workflow.
 */
...
/**
 * Get
 * @desc Redux-Observable Epic which allows to get an entity in "publisherDetails" workflow.
 */
...
/**
 * Auto Complete
 * @desc Redux-Observable Epic which allows to auto-complete values in "publisherDetails" workflow.
 */
...
/**
 * Get Widget Data
 * @desc Redux-Observable Epic which allows to get the data for a widget in "publisherDetails" workflow.
 */
...
/**
 * Update
 * @desc Redux-Observable Epic which allows to update an entity in "publisherDetails" workflow.
 */
...
/**
 * Bulk Update
 * @desc Redux-Observable Epic which allows to update entities in bulk in "publisherDetails" workflow.
 */
