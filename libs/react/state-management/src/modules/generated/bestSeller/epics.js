...
/**
 * Add
 * @desc Redux-Observable Epic which allows to add an entity in "bestSeller" workflow.
 */
...
/**
 * Bulk Add
 * @desc Redux-Observable Epic which allows to add entities in bulk in "bestSeller" workflow.
 */
...
/**
 * Delete
 * @desc Redux-Observable Epic which allows to delete an entity in "bestSeller" workflow.
 */
...
/**
 * Bulk Delete
 * @desc Redux-Observable Epic which allows to delete entities in bulk in "bestSeller" workflow.
 */
...
/**
 * Safe Delete
 * @desc Redux-Observable Epic which allows to safely delete entities in "bestSeller" workflow.
 */
 ...
 * @desc Redux-Observable Epic which allows to dispatch a custom action in "bestSeller" workflow.
 */
...
/**
 * Get
 * @desc Redux-Observable Epic which allows to get an entity in "bestSeller" workflow.
 */
...
/**
 * Auto Complete
 * @desc Redux-Observable Epic which allows to auto-complete values in "bestSeller" workflow.
 */
...
/**
 * Get Widget Data
 * @desc Redux-Observable Epic which allows to get the data for a widget in "bestSeller" workflow.
 */
...
/**
 * Update
 * @desc Redux-Observable Epic which allows to update an entity in "bestSeller" workflow.
 */
...
/**
 * Bulk Update
 * @desc Redux-Observable Epic which allows to update entities in bulk in "bestSeller" workflow.
 */
