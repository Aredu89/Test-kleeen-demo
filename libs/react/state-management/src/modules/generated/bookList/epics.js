...
/**
 * Add
 * @desc Redux-Observable Epic which allows to add an entity in "bookList" workflow.
 */
...
/**
 * Bulk Add
 * @desc Redux-Observable Epic which allows to add entities in bulk in "bookList" workflow.
 */
...
/**
 * Delete
 * @desc Redux-Observable Epic which allows to delete an entity in "bookList" workflow.
 */
...
/**
 * Bulk Delete
 * @desc Redux-Observable Epic which allows to delete entities in bulk in "bookList" workflow.
 */
...
/**
 * Safe Delete
 * @desc Redux-Observable Epic which allows to safely delete entities in "bookList" workflow.
 */
 ...
 * @desc Redux-Observable Epic which allows to dispatch a custom action in "bookList" workflow.
 */
...
/**
 * Get
 * @desc Redux-Observable Epic which allows to get an entity in "bookList" workflow.
 */
...
/**
 * Auto Complete
 * @desc Redux-Observable Epic which allows to auto-complete values in "bookList" workflow.
 */
...
/**
 * Get Widget Data
 * @desc Redux-Observable Epic which allows to get the data for a widget in "bookList" workflow.
 */
...
/**
 * Update
 * @desc Redux-Observable Epic which allows to update an entity in "bookList" workflow.
 */
...
/**
 * Bulk Update
 * @desc Redux-Observable Epic which allows to update entities in bulk in "bookList" workflow.
 */
