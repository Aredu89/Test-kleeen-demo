...
/**
 * Add
 * @desc Redux-Observable Epic which allows to add an entity in "genreDetails" workflow.
 */
...
/**
 * Bulk Add
 * @desc Redux-Observable Epic which allows to add entities in bulk in "genreDetails" workflow.
 */
...
/**
 * Delete
 * @desc Redux-Observable Epic which allows to delete an entity in "genreDetails" workflow.
 */
...
/**
 * Bulk Delete
 * @desc Redux-Observable Epic which allows to delete entities in bulk in "genreDetails" workflow.
 */
...
/**
 * Safe Delete
 * @desc Redux-Observable Epic which allows to safely delete entities in "genreDetails" workflow.
 */
export function safeDelete(action$) {
  return action$.pipe(
    ofType(actions.safeDeleteRequest.type),
    mergeMap((action) =>
      BaseApiService.graphqlEntityCRUD('Book')
        .delete({
          id: action.payload && action.payload.id,
        })
        .pipe(
 ...
 * @desc Redux-Observable Epic which allows to dispatch a custom action in "genreDetails" workflow.
 */
...
/**
 * Get
 * @desc Redux-Observable Epic which allows to get an entity in "genreDetails" workflow.
 */
...
/**
 * Auto Complete
 * @desc Redux-Observable Epic which allows to auto-complete values in "genreDetails" workflow.
 */
...
/**
 * Get Widget Data
 * @desc Redux-Observable Epic which allows to get the data for a widget in "genreDetails" workflow.
 */
...
/**
 * Update
 * @desc Redux-Observable Epic which allows to update an entity in "genreDetails" workflow.
 */
...
/**
 * Bulk Update
 * @desc Redux-Observable Epic which allows to update entities in bulk in "genreDetails" workflow.
 */
