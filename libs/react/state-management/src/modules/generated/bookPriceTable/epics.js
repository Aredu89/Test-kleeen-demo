...
/**
 * Add
 * @desc Redux-Observable Epic which allows to add an entity in "bookPriceTable" workflow.
 */
...
/**
 * Bulk Add
 * @desc Redux-Observable Epic which allows to add entities in bulk in "bookPriceTable" workflow.
 */
...
/**
 * Delete
 * @desc Redux-Observable Epic which allows to delete an entity in "bookPriceTable" workflow.
 */
...
/**
 * Bulk Delete
 * @desc Redux-Observable Epic which allows to delete entities in bulk in "bookPriceTable" workflow.
 */
...
/**
 * Safe Delete
 * @desc Redux-Observable Epic which allows to safely delete entities in "bookPriceTable" workflow.
 */
export function safeDelete(action$) {
  return action$.pipe(
    ofType(actions.safeDeleteRequest.type),
    mergeMap((action) =>
      BaseApiService.graphqlEntityCRUD('Price')
        .delete({
          id: action.payload && action.payload.id,
        })
        .pipe(
 ...
 * @desc Redux-Observable Epic which allows to dispatch a custom action in "bookPriceTable" workflow.
 */
...
/**
 * Get
 * @desc Redux-Observable Epic which allows to get an entity in "bookPriceTable" workflow.
 */
...
/**
 * Auto Complete
 * @desc Redux-Observable Epic which allows to auto-complete values in "bookPriceTable" workflow.
 */
...
/**
 * Get Widget Data
 * @desc Redux-Observable Epic which allows to get the data for a widget in "bookPriceTable" workflow.
 */
...
/**
 * Update
 * @desc Redux-Observable Epic which allows to update an entity in "bookPriceTable" workflow.
 */
...
/**
 * Bulk Update
 * @desc Redux-Observable Epic which allows to update entities in bulk in "bookPriceTable" workflow.
 */
